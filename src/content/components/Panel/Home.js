...
class Panel extends Component {
  ...
  render() {
    const { data: { tabs, handleHover, handleSelect, commandBarFocused, activeMode, activeItemCursor, panelState, setItemCursor } } = this.props

    return (
      <React.Fragment>
        <Header isInputFocused={commandBarFocused} activeItemCursor={activeItemCursor} activeMode={activeMode} panelState={panelState} />
        <Searchbar panelState={panelState} setItemCursor={setItemCursor} />
