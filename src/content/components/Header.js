    ...
    return (
      <div className="cl-py-md cl-border-b-1 cl-border-primary">
        <div className="cl-h-md cl-flex">
          ...
          <a target="_blank" onClick={() => setModalOpen(false)} href="https://forms.gle/J5eeNZpG97aWFDjj6" className="cl-px-lg cl-font-medium cl-text-sm cl-leading-md cl-text-secondary cl-no-underline">
            Send Feedback
          </a>
        </div>
      </div>
